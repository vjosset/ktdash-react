    ...
    return (
        <ul className={classes.news}>
				...
				<li>
					...
					<a href="https://www.warhammer-community.com/wp-content/uploads/2023/03/mVMatxuIveHaDNUd.pdf">2024Q2 Balance Dataslate</a> is loaded!
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>
							<a href="https://www.warhammer-community.com/wp-content/uploads/2023/03/obDcXbbjdnERFx6q.pdf">2023 Q1 dataslate updates</a> have been applied!
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>
							...
							Each of these features was requested by a user in our <a href="https://discord.gg/zyuVDgYNeY">Discord</a>, come say hello!
						</li>
				...
				<li>
					...
					<ul>
						<li>
							Applied <a href="https://www.warhammer-community.com/faqs/#kill-team">Dec 2022 Errata</a> and <a href="https://www.warhammer-community.com/wp-content/uploads/2022/09/4PpUFsmOGVDYGaxW.pdf">2022Q4 Balance Dataslate</a> to all killteams.
						</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						<li>
							Applied <a href="https://www.warhammer-community.com/faqs/#kill-team">Nov 2022 Errata</a>.
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li><h3>KTDash v2 is live!</h3> Please join the <a href="https://discord.gg/zyuVDgYNeY">Discord</a> to report any bugs.</li>
						<li>
							Added new killteams:
							<ul>
								<li><a href="/fa/IMP/kt/INB">Imperial Navy Breachers</a></li>
				...
				<li>
					...
					<ul>
						<li>
							...
							If you have feature requests, now is the time to submit them to the <a href="https://discord.gg/zyuVDgYNeY">Discord</a> "#feature-requests" channel!
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>Join our <a href="https://discord.gg/zyuVDgYNeY">Discord</a>!</li>
						<li>Selected Equipment on the <a href="/dashboard">Dashboard</a> now updates operative characteristics to match!</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>Applied <a href="https://www.warhammer-community.com/2022/06/24/the-new-kill-team-balance-dataslate-is-here/">2022Q2 Balance Dataslate</a></li>
					</ul>
				</li>
				<li>
					<strong>30 May 2022</strong><br/>
					<ul>
						<li>Added <a href="/fa/CHAOS/kt/BLD">Blooded</a> and <a href="/fa/IMP/kt/PHO">Phobos Strike Team</a> killteams.</li>
				...
				<li>
					...
					<ul>
						<li>Added team archetype to <a href="/u">My Rosters</a> and <a href="/dashboard">Dashboard</a>.</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>Applied all changes from the 20 Jan 2022 <a href="https://www.warhammer-community.com/faqs/#kill-team">Errata</a></li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>You can now share your teams with others! Just click the <i class="fas fa-share-square fa-fw"></i> share button to get a custom URL for your team.</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li>Rename/delete/manage my teams</li>
				...
				<li>
					...
					The full compendium JSON dataset is available in GitHub <a href="https://github.com/vjosset/killteamjson">here</a> and will be kept up to date moving forward.
				</li>
				<li>
